...
namespace Amasty\ProductAttachment\Model\Import\Behaviors\FileType;

use Amasty\ProductAttachment\Model\Import\Behaviors\FileType\Processor\TypeProcessorInterface;
        ...
        foreach ($fileTypes as $fileType) {
            if (!$fileType['processor'] instanceof TypeProcessorInterface) {
                throw new \LogicException(
                    sprintf('Imported File type must implement %s', TypeProcessorInterface::class)
                );
            }
