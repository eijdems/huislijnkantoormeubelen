...
class Config extends \Magento\Cms\Model\Wysiwyg\Config
{
    ...
    public function __construct(
        ...
        parent::__construct($this->_backendUrl, $this->_eventManager, $this->_authorization, $this->_assetRepo, $this->_variableConfig, $this->_widgetConfig, $this->_scopeConfig, $this->_storeManager, $this->filesystem, $windowSize, $data, $this->configProvider);
    }
    ...
    public function getConfig($data = [])
    {
        ...
        if ($this->_authorization->isAllowed('Magento_Cms::media_gallery')) {
            ...
            if (isset($this->_windowSize['width']) && isset($this->_windowSize['height']) && ($this->_windowSize['width'] !== null) && ($this->_windowSize['height'] !== null)) {
                $config->addData(
                    [
