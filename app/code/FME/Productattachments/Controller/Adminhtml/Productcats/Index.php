...
class Index extends \FME\Productattachments\Controller\Adminhtml\Productcats
{
    /**
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('FME_Productattachments::fmeextensions_productattachments_productcats');
